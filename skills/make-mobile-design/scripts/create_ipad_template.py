...
<body>
    <div class="device" data-platform="ios" data-form-factor="tablet"
         style="--device-w: ${width}px; --device-h: ${height}px; --device-radius: 38px;">
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate an iPad Pro 11\" device template HTML file (iPadOS, Apple HIG)."
    )
    ...
    parser.add_argument(
        ...
        help="Frame orientation (default: landscape, 1194×834)",
    )
    ...
    width, height = (1194, 834) if args.orientation == "landscape" else (834, 1194)
    ...
    print(f"Created iPad device template ({args.orientation}, {width}×{height}): {out_path}")
    return 0
